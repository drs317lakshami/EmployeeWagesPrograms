...
public class EmployeeWages {
	...
	public EmployeeWages(String companyName, int empRatePerHour, int numOfWorkingDays, int maxHoursInMonth) {
	...
	public static void main(String args[]) {
		EmployeeWages google = new EmployeeWages("Cogent", 50, 15, 200);
		EmployeeWages amazon = new EmployeeWages("Amazon", 80, 20, 120);
		EmployeeWages netflix = new EmployeeWages("Netflix", 90, 18, 220);
